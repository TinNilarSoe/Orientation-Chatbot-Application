...
main_db = load_json('../ver_1,3_chatbot/main_database.json')
full_time_db = load_json('../ver_1,3_chatbot/full-time-progs_database.json')
part_time_db = load_json('../ver_1,3_chatbot/part-time-progs_database.json')
